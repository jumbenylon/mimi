...
import { ArrowLeft, Target, Wallet, TrendingUp, Menu, Plus } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] pb-24 font-sans text-gray-900">
            ...
            <div key={i} className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col gap-4">
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-3">
                  <div className={`p-3 rounded-2xl ${goal.color} bg-opacity-10 text-gray-900`}>
              ...
              <div className="pt-4 border-t border-gray-50 flex justify-between items-center">
                ...
                <div className="text-xs text-right">
                  ...
                  <p className="text-gray-900 font-bold">{fmt(remaining)}</p>
                </div>
              </div>
            </div>
          )
      ...
      <div className="fixed bottom-6 left-6 right-6 bg-gray-900 rounded-2xl p-4 shadow-2xl flex justify-around items-center z-50">
        <Link href="/" className="text-gray-400 flex flex-col items-center gap-1 hover:text-white transition">
          <Wallet size={20} />
        ...
        <Link href="/goals" className="text-white flex flex-col items-center gap-1 opacity-100">
          <Target size={20} />
